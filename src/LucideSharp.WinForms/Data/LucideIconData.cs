// <auto-generated />
// Generated by LucideSharp.IconGenerator on 2026-06-14T12:58:58.8863879Z
// Icon count: 1735

namespace LucideSharp.WinForms;

/// <summary>
/// Embedded Lucide SVG icon data.
/// </summary>
internal static class LucideIconData
{
    private static readonly string[] SvgData = new string[] {
        @"<svg
...
",
    ...
    public static string GetSvg(LucideKind kind)
    {
        var index = (int)kind;
        if ((uint)index >= (uint)SvgData.Length)
        {
            throw new ArgumentOutOfRangeException(nameof(kind), kind, "Unknown Lucide icon kind.");
        }

        return SvgData[index];
    }

    public static int Count => 1735;
}
