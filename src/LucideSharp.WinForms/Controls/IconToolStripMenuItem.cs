...
/// <summary>
/// A Windows Forms tool strip menu item that displays a Lucide SVG icon.
/// Inspired by FontAwesome.Sharp's <c>IconMenuItem</c>.
/// Suitable as a drop-down item for <see cref="IconDropDownButton"/> and
/// <see cref="IconToolStripSplitButton"/>.
/// </summary>
[ToolboxItem(true)]
[DesignTimeVisible(true)]
[DefaultProperty(nameof(Kind))]
[Description("A Windows Forms tool strip menu item supporting Lucide icons")]
public class IconToolStripMenuItem : ToolStripMenuItem
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="IconToolStripMenuItem"/> class.
    /// </summary>
    public IconToolStripMenuItem()
    {
        UpdateImage();
    }
    ...
    /// </summary>
    public IconToolStripMenuItem(string? text, LucideKind kind)
        : this()
    {
        Text = text;
        Kind = kind;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="IconToolStripMenuItem"/> class
    /// with the specified text, icon, and click handler.
    /// </summary>
    public IconToolStripMenuItem(string? text, LucideKind kind, EventHandler? onClick)
        : this(text, kind)
    {
