...
/// <summary>
/// A Windows Forms tool strip split button that displays a Lucide SVG icon.
/// Inspired by FontAwesome.Sharp's <c>IconSplitButton</c>.
/// Use <see cref="IconToolStripMenuItem"/> for drop-down sub-items.
/// </summary>
[ToolboxItem(true)]
[DesignTimeVisible(true)]
[DefaultProperty(nameof(Kind))]
[Description("A Windows Forms tool strip split button supporting Lucide icons")]
public class IconToolStripSplitButton : ToolStripSplitButton
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="IconToolStripSplitButton"/> class.
    /// </summary>
    public IconToolStripSplitButton()
    {
        UpdateImage();
    }
