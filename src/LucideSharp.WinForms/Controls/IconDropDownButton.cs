...
/// <summary>
/// A Windows Forms tool strip drop-down button that displays a Lucide SVG icon.
/// Inspired by FontAwesome.Sharp's <c>IconDropDownButton</c>.
/// </summary>
[ToolboxItem(true)]
[DesignTimeVisible(true)]
[DefaultProperty(nameof(Kind))]
[Description("A Windows Forms tool strip drop-down button supporting Lucide icons")]
public class IconDropDownButton : ToolStripDropDownButton
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="IconDropDownButton"/> class.
    /// </summary>
