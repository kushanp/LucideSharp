...
/// <summary>
/// A Windows Forms tool strip button that displays a Lucide SVG icon.
/// Inspired by FontAwesome.Sharp's <c>IconToolStripButton</c>.
/// </summary>
[ToolboxItem(true)]
[DesignTimeVisible(true)]
[DefaultProperty(nameof(Kind))]
[Description("A Windows Forms tool strip button supporting Lucide icons")]
public class IconToolStripButton : ToolStripButton
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="IconToolStripButton"/> class.
    /// </summary>
